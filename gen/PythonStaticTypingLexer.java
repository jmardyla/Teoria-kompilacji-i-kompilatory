...
public class PythonStaticTypingLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"RANGE", "NUMBER", "STRING", "TYPE_ANNOTATION", "IN", "COLON", "COMMA", 
			"SEMI", "PLUS", "MINUS", "STAR", "SLASH", "VBAR", "AMPERSAND", "LESS", 
			"GREATER", "EQUAL", "DOT", "PERCENT", "EQEQUAL", "NOTEQUAL", "LESSEQUAL", 
			"GREATEREQUAL", "TILDE", "PLUSEQUAL", "MINEQUAL", "STAREQUAL", "SLASHEQUAL", 
			"PERCENTEQUAL", "EXCLAMATION", "NULL", "DECIMALINTLITERAL", "BREAK", 
			"ELSE", "RETURN", "CONTINUE", "DEF", "IF", "WHILE", "FOR", "CLASS", "COMMENT", 
			"OPEN_PAREN", "CLOSE_PAREN", "OPEN_BRACKET", "CLOSE_BRACKET", "OPEN_BRACE", 
			"CLOSE_BRACE", "INT", "STR", "FLOAT", "COMPLEX", "BOOLEAN", "LIST", "TUPLE", 
			"DICT", "SET", "IDENTIFIER", "INDENT", "DEDENT", "NEWLINE", "WS"
		};
	}
	...
	public PythonStaticTypingLexer(CharStream input) {
		super(input);
